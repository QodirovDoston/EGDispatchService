      ...
      <div className="container">
        <div className="grid xl:grid-cols-2 grid-cols-1">
          <div className="relative xl:m-16 m-2">
            <button className="absolute py-1 px-4 -left-6 -top-1 -rotate-[45deg] border border-gray-200 bg-primary text-white font-bold hover:scale-105 duration-500">
              NEW
            </button>
            <div className="purple_border xl:p-8 p-4 border shadow rounded-xl border-gray-300 text-center bg-white">
              ...
              <button className="text-white rounded-[22px] mt-5 bg-primary duration-500 transition hover:bg-text-color font-medium text-lg px-10 py-2.5 text-center hover:scale-105">
                GET A QUOTE
              </button>
            </div>
          </div>
          <div>
            <div className="mt-1 py-2 xl:px-1 px-2">
              ...
              <p className="text-blue-800">
                ...
                Give EG Dispatch Service  a call and he can help you with all your insurance
                needs!
              </p>
              <div className="mt-6">
