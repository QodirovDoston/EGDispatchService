    ...
    <div className="xl:py-20 py-5">
      ...
      <div className="xl:w-[80%] w-[90%] mx-auto text-center">
        ...
        <a href="tel:+1540 4409208">
          <button className="text-white rounded-[22px] mt-5 border-2 flex gap-2 bg-primary duration-500 transition hover:border-gray-400 font-medium text-md  px-5 py-2.5 text-center hover:scale-105">
            Submit
          </button>
        </a>
      </div>
