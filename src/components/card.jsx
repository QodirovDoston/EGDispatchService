...
const Card = () => {
  return (
    <div className="relative xl:m-16 m-2">
      <button className="absolute py-1 px-3 -left-8 -top-2 -rotate-[10deg] border border-black black_border bg-primary text-white font-bold hover:scale-105 duration-500">
        NEW
      </button>
