  ...
  return (
    <div className="text-center">
      ...
      <p className="text-text-color py-8 leading-10">
        At <span className="text-primary"> EG Dispatch Service </span> we strive to
      ...
      <a href="#" className="flex justify-center">
        <button
          className={`text-white rounded-[22px] border-2 flex gap-2 bg-primary duration-500 transition hover:border-primary font-medium text-lg  px-5 py-2.5 text-center hover:scale-105`}
        >
          <Image
