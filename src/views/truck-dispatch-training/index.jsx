...
const TruckDispatchTrainingPage = () => {
  return (
    <>
        ...
        <div className="grid xl:grid-cols-3 grid-cols-1  xl:gap-5 gap-0">
          <div className="item1 xl:col-span-2 col-span-2 row-span-1 ">
            ...
            <a href="" className="flex justify-center py-5">
              <button
                className={`text-white rounded-[22px] mt-5 border-2 flex gap-2 bg-primary hover:bg-text-color duration-150 transition hover:border-gray-400 font-medium text-md  px-5 py-2.5 text-center`}
              >
                <Image
      ...
      <h1 className='text-5xl py-3'>+1(540) 440-9208</h1>
      <h3 className='text-3xl'>Get Started Today!</h3>
      <a href="" className="flex justify-center">
        <button
          className={`text-white rounded-[22px] mt-5 border-2 flex gap-2 bg-primary duration-150 transition hover:border-gray-400 font-medium text-md  px-5 py-2.5 text-center`}
        >
          <Image
            className="hover:scale-110 duration-500"
            width={20}
